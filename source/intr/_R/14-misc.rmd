...
It has become quite common to use the `|>` "piping" operator in R, or the `or `%>%` variant defined in the `magrittr` package. We do not use it much in our tutorials, but we show it here so that you can understand it when you come across it.
