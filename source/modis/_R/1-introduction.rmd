...
## Example: MODIS product: Surface Reflectance Products "MOD09A1"

The "MOD09A1" is a surface reflectance product from scenes acquired using MODIS sensor onboard the Terra satellite hence the prefix "MOD".  They are generated using the first seven, bands of the corresponding full 36 bands. The products provide an estimated "target at surface" spectral reflectance with calibration for atmospheric conditions such as gasses, aerosols, and Rayleigh scattering already taken into account. Global surface reflectance products can be obtained at either 250 m or 500 m spatial resolution, as daily or 8-day composite images. Herein the "MOD09A1" consist of 8-day surface reflectance products at 500 m spatial resolution. A summary of 13 layers that comes with "MOD09A1" HDF-EOS file is available [here](https://lpdaac.usgs.gov/products/mod09a1v006/).
...
m <- data.frame(m[-1,])
colnames(m) <- cn
knitr::kable(m, caption = "MODIS products; # is the product number variant e.g., 'MOD', 'MYD' or 'MCD'.")
