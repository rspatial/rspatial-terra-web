...
dm <- read.table("MODIS_State_QA.txt", header=TRUE, sep = "\t", colClasses = "character", encoding ="UTF-8", stringsAsFactors = FALSE)
...
```{r qcconst}
qa_bits <- matrix(c(1,2,3,6,11,11,12,14,16,16), ncol=2, byrow=TRUE)
...
quality_mask <- modis_mask(qc, 16, qa_bits, reject)
