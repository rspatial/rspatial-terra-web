...
man_pages = [
    (master_doc, 'rs', u'Processint MODIS data',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'modis', u'Processing MODIS data',
   author, 'MODIS', 'An introduction to Processing MODIS data with R.',
   'Miscellaneous'),
]
