...
This book provides a short introduction to satellite data analysis with R. Before reading this you should first learn the [basics of the terra package](http://rspatial.org/terra/). There is another version of this book for [the raster package](http://rspatial.org/raster/rs).
