...
Let's define a general function for a ratio based (vegetation) index. In the function below, `img` is a mutilayer SpatRaster object and `i` and `k` are the indices of the layers (layer numbers) used to compute the vegetation index.
