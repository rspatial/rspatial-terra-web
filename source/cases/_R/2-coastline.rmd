...
Let's transform this to a planar coordinate system. That is not required, but it will speed up computations. We used the [British National Grid](https://spatialreference.org/ref/epsg/osgb-1936-british-national-grid/) coordinate reference system, which is based on the Transverse Mercator (tmerc) projection, with units in meter.  
