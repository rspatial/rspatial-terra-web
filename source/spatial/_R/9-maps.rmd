...
You can make a map with `plot(x)`, were `x` is a `SpatRaster` or `SpatVector`. You can add additional spatial data or text with functions such as `points`, `lines`, `text`
