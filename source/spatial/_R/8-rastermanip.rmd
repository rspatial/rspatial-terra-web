...
```{r, raster-2a1 }
filename <- system.file("exdata/test.tif", package="terra")
filename
```
...
Combine three SpatRaster objects into a RasterStack.
```{r, raster-2b2}
s <- c(r1, r2, r3)
s
nlyr(s)
...
```{r, raster-2b5}
filename <- system.file("exdata/logo.tif", package="terra")
filename
b <- rast(filename)
b
nlyr(b)
