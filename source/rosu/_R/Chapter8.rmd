...
Link the results back to the raster. Note the use of `slope <- copy` to get a *deep copy*. If you do `slope <- r`, both `slope` and `r` point to the *same object in memory*, so you need to avoid that.

```{r, loca18, fig.width=9}
slope <- deepcopy(r)
intercept <- deepcopy(r)
